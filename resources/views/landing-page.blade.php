...
<head>
    ...
    <title>Blectric IoT Panel</title>
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Internet of Things</h4>
									</div>
	                                <p class="text-sm mb-0">The Internet of Things (IoT) refers to the network of interconnected physical devices, vehicles, appliances, and other objects embedded with sensors, actuators, software, and connectivity which enable these objects to collect and exchange data. This allows them to be remotely monitored, controlled, and optimized, leading to improved efficiency, accuracy, and economic benefit.</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Sensors</h4>
									</div>
	                                <p class="text-sm mb-0">Discover how our advanced sensor technology enhances your system's performance. Offering unmatched accuracy and reliability, our sensors are designed for diverse industrial applications. Integrate our solutions to boost operational efficiency and system control</p>
	                            </div>
	                        </div>
							<div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0">Actuator</h4>
									</div>
	                                <p class="text-sm mb-0">Explore our cutting-edge actuators designed to optimize system performance. Engineered for precision and durability, our actuators ensure seamless operation across various industrial applications. Integrate our solutions to elevate efficiency and enhance system control.</p>
	                            </div>
	                        </div>
						</div>
                    </div>
